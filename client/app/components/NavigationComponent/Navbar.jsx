...
class Navbar extends Component {
  ...
  onSignInClick() {
    ...
    // alert(signInEmail + ' ' + signInPassword);
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="login_section">
                  ...
                  <button type='submit' value='submit' id="b_submit" className="btn btn-block btn-primary" onClick={this.onSignInClick} >SUBMIT</button>
                </div>
              </div>
